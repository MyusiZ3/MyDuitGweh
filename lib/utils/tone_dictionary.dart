...
class ToneManager {
  ...
  static const Map<String, Map<AppTone, String>> _dict = {
    ...
    'quick_expense': {
      AppTone.normal: 'Keluar',
      AppTone.genZ: 'Keluar',
      AppTone.milenial: 'Expense',
      AppTone.boomer: 'Pengeluaran',
      AppTone.pasangan: 'Belanja',
    },
    'quick_income': {
      AppTone.normal: 'Masuk',
      AppTone.genZ: 'Masuk',
      AppTone.milenial: 'Income',
      AppTone.boomer: 'Pemasukan',
      AppTone.pasangan: 'Cuan',
    },
    'quick_transfer': {
      AppTone.normal: 'Transfer',
      AppTone.genZ: 'Transfer',
      AppTone.milenial: 'Transfer',
      AppTone.boomer: 'Pindah Buku',
      AppTone.pasangan: 'Transfer',
    },
    'quick_wallet': {
      AppTone.normal: 'Dompet',
      AppTone.genZ: 'Dompet',
      AppTone.milenial: 'Wallets',
      AppTone.boomer: 'Dompet',
